...
if ! command -v rg >/dev/null 2>&1; then
  alias rg='/home/azureuser/.vscode-server/extensions/anthropic.claude-code-2.0.43-linux-x64/resources/native-binary/claude --ripgrep'
fi
export PATH=/home/azureuser/.vscode-server/cli/servers/Stable-6f17636121051a53c88d3e605c491d22af2ba755/server/bin/remote-cli\:/usr/local/sbin\:/usr/local/bin\:/usr/sbin\:/usr/bin\:/sbin\:/bin\:/usr/games\:/usr/local/games\:/snap/bin
